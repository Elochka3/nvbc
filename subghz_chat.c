...
// Заглушка для обработки ошибок воркера
static void chat_worker_overrun_callback(void* context) {
...
int32_t subghz_chat_app(void* p) {
    ...
    subghz_worker_set_overrun_callback(app->worker, chat_worker_overrun_callback);
